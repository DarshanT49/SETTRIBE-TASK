...
const allNavLinks = [
  ...
  { to: '/team-performance', icon: TrendingUp, label: 'Team Performance', roles: ['admin', 'hr', 'employee', 'panel'] },
  { to: '/progress', icon: BarChart3, label: 'My Progress', roles: ['intern'] },
  { to: '/leaderboard', icon: Trophy, label: 'Leaderboard', roles: ['intern'] },
  { to: '/employees/pending', icon: Shield, label: 'Pending Approvals', roles: ['hr'] },
  ...
  { to: '/reports', icon: BarChart3, label: 'Reports', roles: ['admin', 'hr', 'employee'] },
  { to: '/notifications', icon: Bell, label: 'Notifications', roles: ['admin', 'hr', 'employee', 'intern', 'panel'] },
  { to: '/profile', icon: User, label: 'Profile', roles: ['admin', 'hr', 'employee', 'intern', 'panel'] },
];
